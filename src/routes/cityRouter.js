...
var url = "mongodb+srv://Sanjaymurmu:Dumka12345@firstmongo.djx5e.mongodb.net/Practise_set?retryWrites=true&w=majority"
...
//   ]
  ...
  function router(menu){
    ...
    CityRouter.route('/')
      .get(function(req,res){
        mongodb.connect(url,(err,connection)=>{
          if(err){
            ...
            const dbo = connection.db('Practise_set');
            dbo.collection('Practise_set').find({}).toArray((err,data)=>{
              if(err){
      ...
      CityRouter.route('/detail/:id')
      .get(function(req,res){
        var id = req.params.id
        var name = req.query.name
          res.send(`Welcome to the City detail page ${id} ${name}`)
      })
      return CityRouter;
